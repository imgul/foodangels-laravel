...
use App\Models\MenuItemType as MenuItemTypeModel;
...
class MenuItemController extends BackendController
{
    ...
    public function store(MenuItemRequest $request)
    {
        ...
        $menuItem->product_info    = $request->get('product_info');
        ...
        $menuItem->tax_id         = $request->get('tax');
        ...
        if ($request->type == 'add') {
            if (!blank($variations)) {
                foreach ($variations as $variation) {
                    ...
                    $menuItemVariation->restaurant_id                 = $menuItem->restaurant_id;
                    $menuItemVariation->menu_item_type_id         = $variation['typeID'];
                    $menuItemVariation->name                      = $variation['name'];
                    $menuItemVariation->product_info              = $variation['productInfo'];
                    $menuItemVariation->unit_price                = $variation['price'];
                    $menuItemVariation->related_menu_item_id      = $variation['variationMenuItemID'];
            ...
            if (!blank($options)) {
                foreach ($options as $option) {
                    ...
                    $menuItemOption->restaurant_id                 = $menuItem->restaurant_id;
                    $menuItemOption->menu_item_type_id         = $option['typeID'];
                    $menuItemOption->name                      = $option['name'];
                    $menuItemOption->product_info              = $option['productInfo'];
                    $menuItemOption->unit_price                = $option['price'];
                    $menuItemOption->related_menu_item_id      = $option['optionsMenuItemID'];
    ...
    public function modifyUpdateOld(Request $request, $id)
    {
    ...
    public  function getCategoryMenuItem(Request $request)
    {
        ...
        return view('admin.menu-item.category-menuItem', compact('menuItems'));
    }
}
