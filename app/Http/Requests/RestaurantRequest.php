...
class RestaurantRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'week_days_opening' => ['nullable'],
            'week_days_closing' => ['nullable'],
            'weekend_opening'   => ['nullable'],
            'weekend_closing'   => ['nullable'],
    ...
    public function attributes()
    {
        return [
            ...
            'week_days_opening' => trans('validation.attributes.week_days_opening'),
            'week_days_closing' => trans('validation.attributes.week_days_closing'),
            'weekend_opening'   => trans('validation.attributes.weekend_opening'),
            'weekend_closing'   => trans('validation.attributes.weekend_closing'),
