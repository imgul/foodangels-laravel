...
class RolePermissionTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        if (!blank($role)) {
            ...
            $restaurantOwnerPermission[]['name'] = 'menu-items-type';
            $restaurantOwnerPermission[]['name'] = 'menu-items-type_create';
            $restaurantOwnerPermission[]['name'] = 'menu-items-type_edit';
            $restaurantOwnerPermission[]['name'] = 'menu-items-type_delete';
            $restaurantOwnerPermission[]['name'] = 'menu-items-type_show';
            ...
            $restaurantOwnerPermission[]['name'] = 'promo';
            $restaurantOwnerPermission[]['name'] = 'promo_create';
            $restaurantOwnerPermission[]['name'] = 'promo_edit';
            $restaurantOwnerPermission[]['name'] = 'promo_show';
            $restaurantOwnerPermission[]['name'] = 'promo_delete';
