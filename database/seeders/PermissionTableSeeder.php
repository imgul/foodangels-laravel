...
class PermissionTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $i++;
        $permissionArray[$i]['name']       = 'promo';
        $permissionArray[$i]['guard_name'] = 'web';

        $i++;
        $permissionArray[$i]['name']       = 'promo_create';
        $permissionArray[$i]['guard_name'] = 'web';

        $i++;
        $permissionArray[$i]['name']       = 'promo_edit';
        $permissionArray[$i]['guard_name'] = 'web';

        $i++;
        $permissionArray[$i]['name']       = 'promo_show';
        $permissionArray[$i]['guard_name'] = 'web';

        $i++;
        $permissionArray[$i]['name']       = 'promo_delete';
        $permissionArray[$i]['guard_name'] = 'web';
        ...
        $i++;
        $permissionArray[$i]['name']       = 'menu-items-type';
        $permissionArray[$i]['guard_name'] = 'web';

        $i++;
        $permissionArray[$i]['name']       = 'menu-items-type_create';
        $permissionArray[$i]['guard_name'] = 'web';

        $i++;
        $permissionArray[$i]['name']       = 'menu-items-type_edit';
        $permissionArray[$i]['guard_name'] = 'web';

        $i++;
        $permissionArray[$i]['name']       = 'menu-items-type_delete';
        $permissionArray[$i]['guard_name'] = 'web';

        $i++;
        $permissionArray[$i]['name']       = 'menu-items-type_show';
        $permissionArray[$i]['guard_name'] = 'web';
        ...
        $i++;
        $permissionArray[$i]['name']       = 'order_notification';
        $permissionArray[$i]['guard_name'] = 'web';
        ...
        $i++;
        $permissionArray[$i]['name']       = 'live_orders';
        $permissionArray[$i]['guard_name'] = 'web';
