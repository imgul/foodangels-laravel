                                    ...
                                    <div class="col-md-6 " wire:key="{{ $menu_item['id'] }}">
                                        <div class="product-card">
                                            <figure
                                                ...
                                                <img loading="lazy" data-src="{{ $menu_item['image'] }}" class="lazy" alt="product">

                                                <div class="loader-container">
                                                    <img loading="lazy" src="{{ asset('frontend/images/default/loader.gif') }}"
                            ...
                            <div class="col-md-6" wire:key="{{ $other_product['id'] }}">
                                <div class="product-card">
                                    <figure class="product-card-media d-flex justify-content-center align-items-center">
                                        ...
                                        <img loading="lazy" data-src="{{ $other_product['image'] }}" class="lazy" alt="product">

                                        <div class="loader-container">
                                            <img loading="lazy" src="{{ asset('frontend/images/default/loader.gif') }}" class="loader"
                                                alt="loading">
                                        </div>
                                    </figure>
                                    <div class="product-card-content">
...
{{--                                        @else--}}
                                            <a href="#variation-{{ $menu_item['id'] }}"
                                                wire:click.prevent="addToCartModal({{$other_product['id']}},{{ isset($relatedPromo[$other_product['id']]) ? promoPrice($other_product['unit_price'],$other_product['discount_price'],$relatedPromo[$other_product['id']]->amount):$other_product['unit_price'] - $other_product['discount_price'] }} )">
                                                <h4 class="product-card-title">
                                                    {{ \Illuminate\Support\Str::limit($menu_item['name'], 20) }}
                                                </h4>
                                            </a>
