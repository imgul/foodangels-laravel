<div>
    ...
    @if (!blank($carts))
        ...
        <div class="cart-scroll-group">
            ...
            <h3
                class="cart-heading {{ $this->restaurant->delivery_status == \App\Enums\Status::INACTIVE || $this->restaurant->pickup_status == \App\Enums\Status::INACTIVE ? 'mt-0' : '' }} ">
                ...
                @if ($this->time_slots)
                    <div class="form-group">
                        ...
                        <select class="form-select" id="time_slot" name="time_slot" wire:model="time_slot" wire:change="changeTimeSlot">
                            <option value="">{{ __('frontend.time_slots') }}</option>
        ...
        <div class="cart-amount-btn-div">
            <a href="{{ route('checkout.index') }}"
                ...
                @if (!blank($carts) && !blank($carts['items']) && $isActiveCheckout && $restaurant->lowestDeliveryCharge()->min_order <= $subTotalAmount) onclick="return true;"
