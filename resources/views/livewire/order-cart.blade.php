<div>
    ...
    <div class="cart-scroll-group">
        <div class="d-flex justify-content-center aligjn-items-center mt-3 mb-3">
            ...
            @elseif(
            $this->restaurant->pickup_status == \App\Enums\Status::INACTIVE &&
            $this->restaurant->delivery_status == \App\Enums\Status::ACTIVE)
            <p class="delivery_status m-0  fw-semibold">{{ __('frontend.only_delivery') }}</p>
            @endif
        </div>

        <h3 class="cart-heading {{ $this->restaurant->delivery_status == \App\Enums\Status::INACTIVE || $this->restaurant->pickup_status == \App\Enums\Status::INACTIVE ? 'mt-0' : '' }} ">
            {{ __('frontend.your_order_from') . ' ' . \Illuminate\Support\Str::limit($this->restaurant->name, 26) }}
        </h3>
        ...
        <ul class="cart-list">
            ...
            <li class="cart-item">
                <button class="cart-delete" wire:key="{{ $key }}" wire:click.prevent="removeItem('{{ $key }}')" type="button">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M14.0466 3.48634C12.9733 3.37967 11.8999 3.29967 10.8199 3.23967V3.23301L10.6733 2.36634C10.5733 1.75301 10.4266 0.833008 8.86661 0.833008H7.11994C5.56661 0.833008 5.41994 1.71301 5.31328 2.35967L5.17328 3.21301C4.55328 3.25301 3.93328 3.29301 3.31328 3.35301L1.95328 3.48634C1.67328 3.51301 1.47328 3.75967 1.49994 4.03301C1.52661 4.30634 1.76661 4.50634 2.04661 4.47967L3.40661 4.34634C6.89994 3.99967 10.4199 4.13301 13.9533 4.48634C13.9733 4.48634 13.9866 4.48634 14.0066 4.48634C14.2599 4.48634 14.4799 4.29301 14.5066 4.03301C14.5266 3.75967 14.3266 3.51301 14.0466 3.48634Z" fill="#E93C3C" />
                        <path d="M12.8199 5.42699C12.6599 5.26033 12.4399 5.16699 12.2132 5.16699H3.78658C3.55991 5.16699 3.33325 5.26033 3.17991 5.42699C3.02658 5.59366 2.93991 5.82033 2.95325 6.05366L3.36658 12.8937C3.43991 13.907 3.53325 15.1737 5.85991 15.1737H10.1399C12.4666 15.1737 12.5599 13.9137 12.6332 12.8937L13.0466 6.06033C13.0599 5.82033 12.9732 5.59366 12.8199 5.42699ZM9.10658 11.8337H6.88658C6.61325 11.8337 6.38658 11.607 6.38658 11.3337C6.38658 11.0603 6.61325 10.8337 6.88658 10.8337H9.10658C9.37991 10.8337 9.60658 11.0603 9.60658 11.3337C9.60658 11.607 9.37991 11.8337 9.10658 11.8337ZM9.66658 9.16699H6.33325C6.05991 9.16699 5.83325 8.94033 5.83325 8.66699C5.83325 8.39366 6.05991 8.16699 6.33325 8.16699H9.66658C9.93991 8.16699 10.1666 8.39366 10.1666 8.66699C10.1666 8.94033 9.93991 9.16699 9.66658 9.16699Z" fill="#E93C3C" />
                    </svg>
                </button>
                ...
                <div class="cart-action-group">
                    ...
                    <div class="cart-counter">
                        ...
                        <input type="number" step=".01" wire:model="carts.items.{{ $key }}.qty" id="carts.items.{{ $key }}.qty" class="cart-counter-value" wire:keyup="changeEvent('{{ $key }}')" value="{{ $content['qty'] }}" min="1" max="99">
                        <button wire:click.prevent="addItemQty('{{ $key }}')" class="fa-solid fa-plus cart-counter-plus"></button>
                    </div>
                </div>
            </li>
            @endforeach
        ...
        <div class="cart-price-group">
            ...
            <div class="cart-coupon m-0">
                <input wire:ignore wire:key="coupon" type="text" wire:model="coupon" placeholder="{{ __('frontend.apply_coupon') }}">
    ...
    <div class="cart-empty">
        ...
        <img loading="lazy" src="{{ asset('frontend/images/gif/empty.gif') }}" alt="gif">
