                ...
                <div class="col-12 col-md-12 col-lg-8">
                    <div class="card profile-widget mt-0">
                        ...
                        <div class="profile-widget-description">
                            ...
                            <dl class="row">
                                <dt class="col-sm-4">{{ __('levels.product_info') }}</dt>
                                <dd class="col-sm-8">{!! $menuItem->product_info !!}</dd>
                            </dl>
                            <dl class="row">
                            ...
                            @if(!blank($menuItem->taxInfo))
                            <dl class="row">
                                <dt class="col-sm-4">{{ __('levels.tax_rate') }}</dt>
                                <dd class="col-sm-8">{{ $menuItem->taxInfo->label." - ".$menuItem->taxInfo->rate.'%'}}</dd>
                            </dl>
                            @endif
                        </div>
                    </div>
