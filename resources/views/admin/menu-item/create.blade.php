                        ...
                        <form action="{{ route('admin.menu-items.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col">
                                        <label for="product_info">{{ __('levels.product_info') }}</label>
                                        <textarea name="product_info" class="summernote-simple form-control height-textarea @error('product_info')
                                                    is-invalid @enderror" id="product_info">
                                        {{ old('product_info') }}
                                        </textarea>
                                        @error('product_info')
                                        <div class="invalid-feedback">
