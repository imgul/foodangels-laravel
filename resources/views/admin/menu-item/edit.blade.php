                            ...
                            <div class="card-body">
                                                ...
                                                @if(!blank($restaurants))
                                                    @foreach($restaurants as $restaurant)
                                                        <option value="{{ $restaurant->id }}"
                                                            {{ (old('restaurant_id', $menuItem->restaurant_id) == $restaurant->id) ? 'selected' : '' }}> {{ $restaurant->name }}
                                                        </option>
                                                    @endforeach
                                                @endif
                                            </select>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-sm-4">
                                        ...
                                        <input id="unit_price" type="text" name="unit_price" class="form-control {{ $errors->has('unit_price') ? " is-invalid " : '' }}" value="{{ old('unit_price', $menuItem->unit_price) }}">
                                        @error('unit_price')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="form-group col-sm-4">
                                        ...
                                        <input id="discount_price" type="text" name="discount_price" class="form-control {{ $errors->has('discount_price') ? " is-invalid " : '' }}" value="{{ old('discount_price', $menuItem->discount_price) }}">
                                    ...
                                    <div class="form-group col-sm-4">
                                        ...
                                        <select id="tax" name="tax" class="form-control @error('tax') is-invalid @enderror">
                                            ...
                                            <option value="{{ $tax->tax_id }}" {{ ($menuItem->tax_id == $tax->id) ? 'selected' : '' }}>{{ $tax->label.' ('.$tax->rate.'%)' }}</option>
                                            @endforeach
                                        </select>
                                        @error('tax')
                                        <div class="invalid-feedback">
                                ...
                                <div class="form-row">
                                    <div class="form-group col">
                                        ...
                                        <textarea name="description" class="summernote-simple form-control height-textarea @error('description') is-invalid @enderror" id="description">{{ old('description', $menuItem->description) }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
