                    ...
                    <div class="rest-content">
                        <figure class="rest-media">
                            <a class="d-block" href="{{ route('restaurant.show', [$restaurant->slug]) }}">
                                <img loading="lazy" src="{{ asset($restaurant->image) }}" alt="restaurant">
                            </a>
                        </figure>
...
{{--                                    @endif--}}
                                ...
                                <div class="rest-location">
                                    ...
                                    @if(!blank($restaurant->lowestDeliveryCharge()))
                                        <span class=""><i class="fa fa-clock"></i> &nbsp;{{ $restaurant->lowestDeliveryCharge()->delivery_time }}</span>
                                    @endif
                                    @if(!blank($restaurant->postalCode()))
                                        <span class="{{ $restaurant->lowestDeliveryCharge()->delivery_charge != 0 ? 'text-color': 'text-success'}}"><i class="fa fa-bicycle"></i>&nbsp;{{ ( $restaurant->lowestDeliveryCharge()->delivery_charge != 0 ? currencyFormat($restaurant->lowestDeliveryCharge()->delivery_charge) : __('frontend.free') )}} </span>&nbsp;
                                    @endif
                                    @if(!blank($restaurant->postalCode()))
                                        <span class="text-color"><i class="fa fa-shopping-bag"></i>&nbsp;{{ __('frontend.min') }} {{ currencyFormat($restaurant->lowestDeliveryCharge()->min_order) }} </span>&nbsp;
                                    @endif
                                </div>
                            </div>
                            <div class="rest-btns">
                        ...
                        <div class="container-fluid custom-shop">
                            <div class="col-lg-12 col-md-12 pl-0 pr-0">
                                @livewire('show-promo-info', ['restaurant'=>$restaurant])
                            </div>
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="booking-modal-header">
                    ...
                    <img loading="lazy" src="{{ asset('frontend/images/gif/table.gif') }}" alt="gif">
                </div>
                @if ($errors->any())
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="shop-modal-header">
                    <button class="fa-regular fa-circle-xmark" type="button" data-bs-dismiss="modal"></button>
                    <img loading="lazy" src="{{ $restaurant->image }}" alt="restaurant">
                </div>
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="about">
                        <div class="shop-modal-about">
                            ...
                            @if($qrCodeFound)
                                <img loading="lazy" src="{!! $qrCode !!}" alt="qr">
                            @else
                                <img loading="lazy" src="data:image/png;base64,{!! $qrCode !!}" alt="qr">
                            @endif
                        </div>
                    </div>
