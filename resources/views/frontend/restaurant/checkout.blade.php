        ...
        <form id="payment-form" action="{{ route('checkout.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="checkout-group">
                <div class="checkout-delivery">
                            ...
                            <div class="form-address">
                                <div class="row justify-content-between">
                                    <div class="col-12 col-lg-6 form-group">
                                        ...
                                        <input id="street_name" type="text" required class="form-control @error('street_name') is-invalid @enderror street_name" placeholder="{{ __('levels.street_name') }}" name="street_name" value="{{ old('street_name', @$delivery_address->street_name) }}">
                                        @error('street_name')
                                    ...
                                    <div class="col-12 col-lg-6 form-group">
                                        ...
                                        <input id="house_number" type="text" required class="form-control @error('house_number') is-invalid @enderror house_number" placeholder="{{ __('levels.house_number') }}" name="house_number" value="{{ old('house_number', @$delivery_address->house_number) }}">
                                        @error('house_number')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="row justify-content-between">
                                    <div class="col-12 col-md-6 form-group">
                                        ...
                                        <input id="post_code" type="number" required class="form-control @error('post_code') is-invalid @enderror post_code" placeholder="{{ __('levels.post_code') }}" name="post_code" value="{{ old('post_code', @$delivery_address->postal_code) }}">
                                        @error('post_code')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                    ...
                                    <div class="col-12 col-md-6 form-group">
                                        ...
                                        <input id="city" type="text" class="form-control @error('city') is-invalid @enderror city" placeholder="{{ __('levels.city') }}" name="city" value="{{ old('city', @$delivery_address->city) }}">
                                        @error('city')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="row justify-content-between">
                                    <div class="col-12 col-md-6 form-group">
                                        ...
                                        <input id="floor" type="text" class="form-control @error('floor') is-invalid @enderror floor" placeholder="{{ __('levels.floor') }}" name="floor" value="{{ old('floor', @$delivery_address->floor) }}">
                                        @error('floor')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                    ...
                                    <div class="col-12 col-md-6 form-group">
                                        ...
                                        <input id="company_name" type="text" class="form-control @error('company_name') is-invalid @enderror company_name" placeholder="{{ __('levels.company_name') }}" name="company_name" value="{{ old('company_name', @$delivery_address->company_name) }}">
                                        @error('company_name')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="row justify-content-between">
                                    <div class="col-12 form-group">
                                        ...
                                        <input id="note" type="text" class="form-control @error('note') is-invalid @enderror note" placeholder="{{ __('levels.add_note') }}" name="note" value="{{ old('note', @$delivery_address->note) }}">
                                        @error('note')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                    ...
                    <div class="checkout-card mb-0">
                        ...
                        <div class="row justify-content-between">
                            <div class="col-12 col-md-6 form-group">
                                ...
                                <input class="form-control first_name @error('first_name') is-invalid @enderror" type="text" id="first_name" name="first_name" required value={{ old('first_name', @$user->first_name) }}>
                            ...
                            <div class="col-12 col-md-6 form-group">
                                ...
                                <input class="form-control last_name @error('last_name') is-invalid @enderror" type="text" id="last_name" name="last_name" required value={{ old('last_name', @$user->last_name) }}>
                        ...
                        <div class="row justify-content-between">
                            <div class="col-12 col-md-6 form-group">
                                ...
                                <input class="form-control email @error('email') is-invalid @enderror" type="email" id="email" name="email" required value={{ old('email', @$user->email) }}>
                            ...
                            <div class="col-12 col-md-6 form-group">
                                ...
                                <input class="form-control mobile @error('mobile') is-invalid @enderror phone" type="tel" id="number" name="mobile" onkeypress='validate(event)' required value={{ old('mobile', @$user->phone) }}>
                        ...
                        <input type="hidden" name="total_delivery_charge" id="total_delivery_charge" value="0">
                        ...
                        <div class="form-group mb-0">
                            ...
                            <div class="row justify-content-between">
                                <div class="col-12  form-group">
                                    <select class="form-select" name="payment_type" id="payment_type" onchange="myPaymentFunction()" class="form-control @error('payment_type') is-invalid @enderror ">

                                        <option value="{{ App\Enums\PaymentMethod::CASH_ON_DELIVERY }}" @if (old('payment_type')==App\Enums\PaymentMethod::CASH_ON_DELIVERY) selected="selected" @endif>
                                            {{ __('frontend.cash_on_delivery') }}
                                        </option>

                                        @if ($is_auth && auth()->user()->balance->balance >= $totalPayment)
                                        <option value="{{ App\Enums\PaymentMethod::WALLET }}" @if (old('payment_type')==App\Enums\PaymentMethod::WALLET) selected="selected" @endif>
                                        ...
                                        <option value="{{ App\Enums\PaymentMethod::STRIPE }}" @if (old('payment_type')==App\Enums\PaymentMethod::STRIPE) selected="selected" @endif>
                                        ...
                                        <option value="{{ App\Enums\PaymentMethod::PAYSTACK }}" @if (old('payment_type')==App\Enums\PaymentMethod::PAYSTACK) selected="selected" @endif>
                                            {{ __('frontend.paystack') }}
                                        </option>
                                        @endif

                                        @if (setting('paypal_client_id') && setting('paypal_client_secret'))
                                        <option value="{{ App\Enums\PaymentMethod::PAYPAL }}" @if (old('payment_type')==App\Enums\PaymentMethod::PAYPAL) selected="selected" @endif>
                                            {{ __('frontend.paypal') }}
                                        </option>
                                        @endif

                                        @if (setting('razorpay_key') && setting('razorpay_secret'))
                                        <option value="{{ App\Enums\PaymentMethod::RAZORPAY }}" @if (old('payment_type')==App\Enums\PaymentMethod::RAZORPAY) selected="selected" @endif>
                                            {{ __('frontend.razorpay') }}
                                        </option>
                                        @endif

                                        @if (setting('paytm_merchant_id') && setting('paytm_merchant_key'))
                                        <option value="{{ App\Enums\PaymentMethod::PAYTM }}" @if (old('payment_type')==App\Enums\PaymentMethod::PAYTM) selected="selected" @endif>
                                            {{ __('frontend.paytm') }}
                                        </option>
                                        @endif

                                        @if (setting('phonepe_merchant_id') && setting('phonepe_merchant_user_id') && setting('phonepe_salt_key'))
                                        <option value="{{ App\Enums\PaymentMethod::PHONEPE }}" @if (old('payment_type')==App\Enums\PaymentMethod::PHONEPE) selected="selected" @endif>
                                            {{ __('frontend.phonePe') }}
                                        </option>
                                        @endif
                                        ...
                                        <option value="{{ App\Enums\PaymentMethod::SSLCOMMERZ }}" @if (old('payment_type')==App\Enums\PaymentMethod::SSLCOMMERZ) selected="selected" @endif>
                    ...
                    <button type="submit" class="form-btn booking-confirmation-btn" @if ($menuitems['totalAmount'] <=0) disabled @endif>
                            ...
                            <dl>
                                ...
                                @if (isset($item['variations']))
                                 @foreach ($item['variations'] as $variation)
                                     <dd class="fw-bold">{{ $variation['name'] }} </dd>
                                 @endforeach
                                @endif
            ...
            <form id="addressForm" method="post">
                ...
                <div class="address-modal-search modalAddressSearch justify-content-between">
                    ...
                    <div id="autocomplete-container" class="w-100">
                        <input id="autocomplete-input" class="address autocomplete-input @error('new_address') is-invalid @enderror" name="new_address" type="text" placeholder="{{ __('frontend.search') }}">
                    </div>
                ...
                <div class="address-modal-details">
                    ...
                    <input id="apartment" type="text" class="form-control @error('apartment') is-invalid @enderror apartment" placeholder="{{ __('levels.apartment') }}" name="apartment" value="{{ old('apartment') }}">
                    @error('apartment')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="address-modal-label-group">
                    ...
                    <div id="other">
                        <input id="label_name" type="text" class="address-modal-label-input label-name @error('label_name') is-invalid @enderror" placeholder="{{ __('levels.label_example') }}" name="label_name" value="{{ old('label_name') }}">
...
<!-- For backend Js -->
<script async src="https://maps.googleapis.com/maps/api/js?key={{ setting('google_map_api_key') }}&libraries=places&callback=initMap">
</script>
