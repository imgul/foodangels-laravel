            ...
            <div class="col-12 col-lg-8 col-xl-9">
                <h3 class="order-details-title">
                    <a href="{{ route('account.order') }}">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M9.57 5.92969L3.5 11.9997L9.57 18.0697" stroke="#EE1D48" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M20.4999 12H3.66992" stroke="#EE1D48" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                    </a>
                ...
                <div class="pt-3">
                    <ul class="order-track">
                        ...
                        @else
                        <li class=" {{ $order->status >= \App\Enums\OrderStatus::PENDING ? 'tracked active' : '' }}">
                            <span class="line"></span>
                            <i class="fa-solid fa-circle-check"></i>
                        ...
                        <li class=" {{ $order->status >= \App\Enums\OrderStatus::ON_THE_WAY ? 'tracked active' : '' }}">
                            <span class="line"></span>
                            <i class="fa-solid fa-circle-check"></i>
                ...
                <div class="order-details" id="invoice-print">
                    ...
                    <div class="order-group">
                        ...
                        <div class="order-box status">
                            ...
                            <ul class="order-box-list">
                                <li class="order-box-item"><b> {{ __('frontend.order_status') }} :</b><span class="badge-text blue"> {{ trans('order_status.' . $order->status) }}</span>
                                </li>
                                <li class="order-box-item"><b>{{ __('levels.order_type') }} :</b>
                                    <p> {{ $order->getOrderType }}</p>
                                </li>
                                @if($order->time_slot)
                                <li class="order-box-item"><b>{{ __('frontend.time_slot') }} :</b>
                                    <p> {{ $order->time_slot }}</p>
                                </li>
                                @endif
                    ...
                    <ul class="order-price-list">
                        ...
                        <li><span>{{ __('frontend.subtotal') }}</span>
                            <span class="pe-xxl-5 pe-xl-4 pe-lg-1 pe-md-2">{{ currencyFormat($order->sub_total) }}</span>
                        </li>
