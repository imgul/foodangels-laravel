...
Breadcrumbs::for ('promo', function ($trail) {
    $trail->parent('dashboard');
    $trail->push(trans('validation.attributes.promo'), route('admin.promo.index'));
});

// Dashboard / promo / Add
Breadcrumbs::for ('promo/add', function ($trail) {
    $trail->parent('promo');
    $trail->push(trans('validation.attributes.add'));
});

// Dashboard / promo / Edit
Breadcrumbs::for ('promo/edit', function ($trail) {
    $trail->parent('promo');
    $trail->push(trans('validation.attributes.edit'));
});

Breadcrumbs::for ('promo/show', function ($trail) {
    $trail->parent('promo');
    $trail->push(trans('validation.attributes.view'));
});
...
/* Menu Items Types breadcrumbs */
// Dashboard / category
Breadcrumbs::for('menu-items-type', function ( $trail) {
    $trail->parent('dashboard');
    $trail->push(trans('validation.attributes.menu-items-type'), route('admin.menu-items-type.index'));
});

// Dashboard / menu-items-type / Add
Breadcrumbs::for('menu-items-type/view', function ( $trail) {
    $trail->parent('menu-items-type');
    $trail->push(trans('validation.attributes.view'));
});

Breadcrumbs::for('menu-items-type/add', function ( $trail) {
    $trail->parent('menu-items-type');
    $trail->push(trans('validation.attributes.add'));
});

// Dashboard / menu-items-type / Edit
Breadcrumbs::for('menu-items-type/edit', function ( $trail) {
    $trail->parent('menu-items-type');
    $trail->push(trans('validation.attributes.edit'));
});
/* Menu Items Type breadcrumbs ends */
