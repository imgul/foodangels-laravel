...
//    Route::post('checkout',                                 [CheckoutController::class, 'store'])->name('checkout.store')->middleware('auth');
    ...
    Route::post('checkPostal', [CheckoutController::class, 'checkPostal'])->name('checkPostal');
    ...
    Route::get('/filter',                                   [SearchController::class, 'filters'])->name('filters');
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'installed', 'license-activate', 'backend_permission'], 'as' => 'admin.'], function () {
    ...
    Route::get('menu-items/{id}/modify',                    [MenuItemController::class, 'modify'])->name('menu-items.modify');
    Route::post('menu-items/{id}/modify',                   [MenuItemController::class, 'modifyUpdate'])->name('menu-items.modify');
    Route::post('menu-items/category/menuItem',             [MenuItemController::class, 'getCategoryMenuItem'])->name('category.menuItem');

    Route::resource('menu-items-type',            MenuItemTypeController::class);
    Route::get('menu-item-type/get-menu-items-type',        [MenuItemTypeController::class, 'getMenuItemType'])->name('menu-items-type.get-menu-item-type');
    ...
    Route::get('order_notification',                        [OrderNotificationController::class, 'index'])->name('order-notification.index');
    Route::get('order_notification/{id}/accept/{deliveryStatus}', [OrderNotificationController::class, 'accept'])->name('order-notification.accept');
    ...
    Route::get('live_orders',                               [OrderController::class, 'liveOrders'])->name('orders.live-orders');
    Route::get('get-live-orders',                           [OrderController::class, 'getliveOrders'])->name('orders.get-live-Order');

    Route::resource('promo', PromoController::class);
    Route::get('promo-menus/{id}', [PromoController::class, 'getMenus'])->name('promo.get-menus');
    Route::post('promo-menu-store', [PromoController::class, 'saveMenus'])->name('promo-menu-store');

    Route::resource('coupon',                               CouponController::class);
    Route::get('test-coupon',                               [CouponController::class, 'testFunction']);

    Route::resource('restaurants',                           RestaurantsController::class);
    Route::get('postalCode/{restaurant}', [RestaurantsController::class, 'postalCodeIndex'])->name('postalCode.index');
    Route::get('postalCode/create/{restaurant}', [RestaurantsController::class, 'postalCodeCreate'])->name('postalCode.create');
    Route::post('postalCode/store', [RestaurantsController::class, 'postalCodeStore'])->name('postalCode.store');
    Route::get('postalCode/edit/{id}', [RestaurantsController::class, 'postalCodeEdit'])->name('postalCode.edit');
    Route::put('postalCode/update/{id}', [RestaurantsController::class, 'postalCodeUpdate'])->name('postalCode.update');
    Route::delete('postalCode/delete/{restaurant}/{id}', [RestaurantsController::class, 'postalCodeDestroy'])->name('postalCode.delete');
    Route::get('get-postalCode', [RestaurantsController::class, 'getPostalCode'])->name('get-postalCode');
